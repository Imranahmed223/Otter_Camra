...
import {NativeModules, Platform, StyleSheet, Text, View, Image, TouchableOpacity} from 'react-native'
...
import { LarixUtils } from './LarixUtils.js'
...
class MainScreen extends React.Component {
  ...
  getConfigState = ()  => {
    ...
    const cameraId = (pos == 'front' ? videoConfig.defaultFrontCamera : videoConfig.defaultBackCamera)
  ...
  startSetup = () => {
    ...
    this.props.navigation.navigate("SetupRoot") //, {cameraInfo: cameraInfo})
  ...
  switchCamera = () => {
    ...
    camId = (pos == 'back' ? this.state.videoConfig.defaultFrontCamera : this.state.videoConfig.defaultBackCamera)
  ...
  handleCaptureState = (isActive, message) => {
    ...
    let state = {captureActive: isActive, 
  ...
  StreamerControls = (props) => {
    if (!this.state.captureActive) {
      return (
        <View style={styles.rightControls}>
          <TouchableOpacity onPress={this.startSetup}
          ...
          <TouchableOpacity style={[styles.roundButton, styles.disabledStyle]}>
            <Image source={require('./img/mute_on.png')} />
          </TouchableOpacity>        
          <TouchableOpacity style={[styles.roundButton, styles.disabledStyle]}>
            <Image source={require('./img/capture.png')} />
          </TouchableOpacity>                
        </View>           
      )
    }
    return (
      <>
        ...
        <TouchableOpacity onPress={this.switchCamera} style={styles.roundButton}>
          <Image source={require('./img/flip.png')} />
        </TouchableOpacity>
        </View>
        <View style={styles.rightControls}>
          <TouchableOpacity onPress={this.startSetup} disabled={this.state.isStreaming}
              style={[styles.roundButton, this.state.isStreaming ? styles.disabledStyle : styles.normalStyle]}>
            <Image source={require('./img/settings.png')} />
          </TouchableOpacity>        
          <TouchableOpacity onPress={this.toggleFlash} disabled={!this.state.hasFlash} 
            style={this.state.hasFlash ? styles.roundButton : [styles.roundButton, styles.disabledStyle]}>
            <Image source={require('./img/flash.png')} />
          </TouchableOpacity>        
          <TouchableOpacity onPress={this.startStream} style={this.bigButton}>
            <Image source={this.state.isStreaming ? require('./img/stop.png'): require('./img/start.png') } />
          </TouchableOpacity>
          <TouchableOpacity onPress={this.toggleMute} style={styles.roundButton}>
            <Image source={this.state.mute ? require('./img/mute_off.png') : require('./img/mute_on.png')} />
          </TouchableOpacity>        
          <TouchableOpacity onPress={this.takeSnapshot} style={[styles.roundButton, styles.disabledStyle]}>
            <Image source={require('./img/capture.png')} />
          </TouchableOpacity>        
        </View>   
      </>   
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <Streamer style={{flex: 1,width:"100%"}}
            ...
            ref = {this.streamer} />
        <this.StreamerControls active={this.state.captureActive} isStreaming={this.state.isStreaming}/>
        ...
        <View style={styles.duration}>
          <this.TextView style={styles.durationText} text={this.state.duration} />
